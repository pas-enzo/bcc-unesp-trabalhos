...
int main(){
	...
	int ten=0, five=0, one=0, sobra=0; //contadores
	...
	if(one!=0)
		printf("%d nota(s) de B$1.00.\n", one);
		
	if(cfif!=0)
		printf("%d moeda(s) de cB$0.50.\n", cfif);
		
	if(ctwf!=0)
		printf("%d moeda(s) de cB$0.25.\n", ctwf);
		
	if(cten!=0)
		printf("%d moeda(s) de cB$0.10.\n", cten);
		
	if(cfiv!=0)
		printf("%d moeda(s) de cB$0.05.\n", cfiv);
		
	if(ccen!=0)
		printf("%d moeda(s) de cB$0.01.\n", ccen);
